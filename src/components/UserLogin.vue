      ...
      <div class="user-login-form-warp">
        <div class="user-login-form">
          <div class="user-login-avatar">
            <img :src="user.avatarUrl" alt="" @mousedown.stop class="login-avatar" @click.stop="toggleAvatarSelect">
            <transition name="slide">
              <div class="select-avatar-warp" @mousedown.stop v-show="isShow">
                <div class="avatar-input-warp">
                  <input type="text" class="avatar-input"  @keypress.enter="addQQAvatar(qq)" v-model="qq" @click.stop="" placeholder="請輸入QQ號碼">
          ...
          <div class="form-input-warp" @mousedown.stop>
            <div class="form-group">
              <input type="text" class="form-input input-text" autocomplete="new-password" placeholder="用戶名" v-model="user.name">
            ...
            <div class="form-group">
              <input type="password" class="form-input input-pass" autocomplete="new-password" placeholder="密碼">
            </div>
    ...
    methods:{
      ...
      addQQAvatar(qq){
        ...
        if(qqReg.test(qq)){
          ...
          Message.error("輸入正確的QQ號有誤")
        }
      },
      login(){
        if(this.user.name===''){
          Message.error("請輸入用戶名稱！");
          return
        }
